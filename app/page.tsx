...
import { PlusIcon, SearchIcon, XIcon, MinusIcon, MaximizeIcon, DownloadIcon } from 'lucide-react'
...
export default function Windows95NotesApp() {
  ...
  return (
    <div className={`flex flex-col h-screen ${
      ...
      {/* Main Window */}
      <div className="flex-1 flex m-1 border-win95 bg-win95-gray-200">
        {/* Sidebar */}
        <div className="w-64 bg-win95-gray-200 border-r border-win95-gray-400 flex flex-col">
          <div className="p-2 bg-win95-gray-400 text-black font-bold border-b border-win95-gray-500 flex items-center">
            <Windows95Icon />
            Notes
          </div>
          <div className="p-2">
          ...
          {activeNote ? (
            <>
              ...
              <div className={`p-1 flex justify-between items-center ${
                ...
                <div className="flex items-center">
                  <Windows95Icon />
                  <span className="font-bold text-white">{activeNote.title}</span>
                </div>
                <div className="flex">
                  <button className="px-2 py-0.5 bg-win95-gray-200 border-win95 active:border-win95-inset mr-1">
                    <MinusIcon className="w-3 h-3" />
                  </button>
                  <button className="px-2 py-0.5 bg-win95-gray-200 border-win95 active:border-win95-inset mr-1">
                    <MaximizeIcon className="w-3 h-3" />
                  </button>
                  <button onClick={() => setActiveNote(null)} className="px-2 py-0.5 bg-win95-gray-200 border-win95 active:border-win95-inset">
                    <XIcon className="w-3 h-3" />
                  </button>
                </div>
              </div>
